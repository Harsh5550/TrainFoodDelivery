...
import com.harsh.trainfooddelivery.databinding.DeliveryForgotPasswordBinding;
import com.harsh.trainfooddelivery.databinding.RestaurantForgotPasswordBinding;
...
public class DeliveryForgotPassword extends AppCompatActivity {
        private DeliveryForgotPasswordBinding binding;
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            binding=DeliveryForgotPasswordBinding.inflate(getLayoutInflater());
            ...
            mAuth.signInWithCredential(credential)
                    .addOnCompleteListener(this, task -> {
                        if(task.isSuccessful()){
                            loading(false);
                            Intent intent=new Intent(getApplicationContext(), DeliveryChangePassword.class);
                            intent.putExtra("phone", "+91"+binding.inputNumber.getText().toString());
