...
public class RestaurantForgotPassword extends AppCompatActivity {
        private RestaurantForgotPasswordBinding binding;
        ...
        protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            binding=RestaurantForgotPasswordBinding.inflate(getLayoutInflater());
            ...
            mAuth.signInWithCredential(credential)
                    .addOnCompleteListener(this, task -> {
                        if(task.isSuccessful()){
                            loading(false);
                            Intent intent=new Intent(getApplicationContext(), RestaurantChangePassword.class);
